...
class DatabaseConnection {
  ...
  public static getInstance(): DatabaseConnection {
    ...
    if (!this.instance) {
      ...
      console.log('%cNew database instance was created', COLORS.blue);
    }
  ...
  public connect(): void {
    ...
    if (!this.connected) {
      this.connected = true;
      console.log('%cDatabase connection success', COLORS.green);
      return;
    }

    console.log('%cDatabase ALREADY connected', COLORS.cyan);
  }
  ...
  public disconnect(): void {
    ...
    if (this.connected) {
      ...
      console.log('%cDatabase connection closed', COLORS.red);
      return;
    }

    console.log('%cDatabase ALREADY disconnected', COLORS.orange);
  }
}
